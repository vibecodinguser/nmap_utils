"""Модуль для обработки GeoJSON файлов"""
import uuid
...
def process_geojson(geojson_path):
    """Обрабатывает GeoJSON файл и возвращает словарь с paths и points"""
    output = {"paths": {}, "points": {}}
    ...
    try:
        ...
        for idx, row in gdf.iterrows():
            # Собираем значения category_t и title из properties
        ...
        raise Exception(f"Ошибка обработки GeoJSON: {str(e)}")

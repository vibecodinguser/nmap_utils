...
"""
Получаем GeoJSON файл и извлекаем из него координаты объекта с помощью geopandas.
"""


def process_geojson(file_path: str) -> Dict[str, Any]:
    try:
    ...
    # Проверки
    if gdf.empty:
        raise ProcessingError(ERR_SHAPEFILE, "GeoJSON пуст")
